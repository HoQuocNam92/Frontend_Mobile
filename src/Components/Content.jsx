        ...
        <div className="contents-feture">
          {products.map((product, index) => (
            <div className="contents--product" key={product.id}>
              ...
              <Link to={`/product/list/${product.id}`} className="click-buy">Mua ngay</Link>
            </div>
          ))
          }
        </div>
          ...
          <div className="contents-feture">
            {products_mobile.map((product, index) => (
              <div className="contents--product" key={product.id}>
                ...
                <h3 className="price-old">{product.oldPrice}</h3>
                <Link to={`/product/${product.id}`} className="click-buy">Mua ngay</Link>
              </div>
            ))
            }
          </div>
          ...
          <div className="contents-feture">
            {products_laptap.map((product, index) => (
              <div className="contents--product" key={product.id}>
                ...
                <h3 className="price-old">{product.oldPrice}</h3>
                <Link to={`/product/laptop/${product.id}`} className="click-buy">Mua ngay</Link>
              </div>
            ))
            }
          </div>
          ...
          <div className="contents-feture">
            {products_phukien.map((product, index) => (
              <div className="contents--product" key={product.id}>
                ...
                <h3 className="price-old">{product.oldPrice}</h3>
                <Link to={`/product/phukien/${product.id}`} className="click-buy">Mua ngay</Link>
              </div>
            ))
            }
          </div>
