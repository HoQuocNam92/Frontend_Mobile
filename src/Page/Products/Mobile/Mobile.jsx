                ...
                <div className={Styles.wrapper__box}>
                    <div className={Styles.product}>
                        ...
                        <div className={Styles.product__left}>
                            <img className={Styles.img_products_mobile} src={SlideShow} alt={products.name} />
                            <div className={Styles.product_details}>
                                <div className={Styles.info_details}>
                                    ...
                                    <div className={Styles.info_product_safe}>
                                        <i class="fa-solid fa-shield"></i>Bảo hành chính hãng điện thoại 1 năm tại các
                                        trung tâm bảo hành hãng
                                    </div>
                                    <div className={Styles.info_product_box}>
                                        <i class="fa-solid fa-box"></i> Bộ sản phẩm gồm: Hộp, Sách hướng dẫn ,Cây lấy
                                        sim, Ốp lưng, Củ sạc nhanh
                                    </div>
                                    <div className={Styles.info_product_changeError}>
                                        <i class="fa-solid fa-bolt"></i> Hư gì đổi nấy 12 tháng tại 2966 siêu thị toàn
                                    ...
                                    <div className={Styles.product__option}>
                                        ...
                                        <div className={Styles.list__sale}>
                                            <p className={Styles.list__sale_vanban}>
                                                1.Cơ hội trúng 10 xe máy Yamaha Sirius mỗi tháng, tổng giải thưởng lên
                                                đến 5 Tỷ
                                            </p>
                                            <p className={Styles.list__sale_vanban}>
                                                2.Nhập mã VNPAYTGDD4 giảm từ 50,000đ đến 100,000đ (áp dụng tùy giá trị
                                                đơn hàng) khi thanh toán qua VNPAY-QR
                                            </p>
                                            <p className={Styles.list__sale_vanban}>
                                                3.Cơ hội nhận ngay Phiếu mua hàng trị giá 1,000,000đ khi tham gia Trả
                                                góp Duyệt qua điện thoại, giao hàng tận nhà
                                            </p>
                                        </div>
                                    </div>
