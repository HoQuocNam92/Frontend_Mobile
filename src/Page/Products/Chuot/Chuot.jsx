                        ...
                        <div className={Styles.product}>
                            ...
                            <div className={Styles.product__right}>
                                <div className={Styles.product__info}>
                                    <div className={Styles.product__info}>
                                        <h4 className={Styles.products__sale}>
                                            Online giá rẻ quá
                                        </h4>
                                        <h4 className={Styles.price__list}>
                                            {products.price}
                                        </h4>
                                        <h4 className={Styles.price__list}>
                                            {products.oldPrice}
                                ...
                                <div className={Styles.product__option}>
                                    ...
                                    <div className={Styles.list__sale}>
                                        <p className={Styles.list__sale_vanban}>
                                            Cơ hội trúng 10 xe máy Yamaha Sirius
                                            mỗi tháng, tổng giải thưởng lên đến
                                            390 T
                                        </p>
                                        <p className={Styles.list__sale_vanban}>
                                            Nhập mã VNPAYTGDD4 giảm từ 50,000đ
                                            đến 100,000đ (áp dụng tùy giá trị
                                            đơn hàng) khi thanh toán qua
                                            VNPAY-QR{' '}
                                        </p>
                                        <p className={Styles.list__sale_vanban}>
                                            Cơ hội nhận ngay Phiếu mua hàng trị
                                            giá 1,000,000đ khi tham gia Trả góp
                                            Duyệt qua điện thoại, giao hàng tận
                                            nhà{' '}
                                        </p>
                                    </div>
                                    <div className={Styles.box__handle}>
                                        ...
                                        <div className={Styles.add__to__cart}>
                                            <Link
                                                to={`/product/addCart/${products.id}`}
                                            >
                                                Mua ngay
                                            </Link>
                                        </div>
