                ...
                <div className="container_content_box">
                    ...
                    <div className="content_box_right">
                        <div className="content_box_right_right">
                            ...
                            <div className="buy_now_sa">
                                <Link to="/buy">Mua ngay</Link>
                            </div>
                            <div className="buy_now_s">
                                <Link to="/buygiamgia">Mua trả góp 0Đ</Link>
                            </div>
                            <div className="buy_now_a">
                                <Link to="/buygiamgia">Mua trả góp 0% Thẻ</Link>
                            </div>
                        </div>
                    </div>
                </div>
